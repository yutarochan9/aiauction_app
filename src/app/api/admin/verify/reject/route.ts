...
export async function POST(request: NextRequest) {
  ...
  await supabaseAdmin.from('notifications').insert({
    ...
    body: `Your identity verification was not approved. Reason: ${reason ?? 'No reason provided'}. Please resubmit.`,
    url: '/verify',
  })
